   ...
   <section className='py-10 overflow-y-hidden'>
     <div className='flex flex-col justify-center items-center gap-8  text-white'>
        ...
        <FaSpotify className='text-4xl'/>
          ...
          <h1 className='font-bold text-center w-100 leading-tight text-5xl '>Welcome back</h1>
  ...
  <p className="text-red-500 text-xs text-center font-medium">
    *{error}
            ...
            <div className='flex flex-col gap-2'>
                ...
                <input type="email" onChange={(e)=>setEmail(e.target.value)} value={email} className='p-3 w-75 border border-[#7C7C7C] rounded-sm text-sm font-semibold'  required/>
            </div>
            <div className='flex flex-col gap-2'>
                <label className='font-semibold text-xs' >Password</label>
                <input type="password" onChange={(e)=>setPassword(e.target.value)} value={password} className='p-3 w-75 border border-[#7C7C7C] rounded-sm text-sm font-semibold'  required/>
                
            </div>
            <div className='flex flex-col mt-2 '>
                <input type="submit" className='py-2 w-75 hover:bg-[#3BE477] transition-all duration-300 hover:cursor-pointer text-black rounded-3xl bg-[#14d959] text-lg  font-semibold' value={loading?"loading...":"Login"}/>
