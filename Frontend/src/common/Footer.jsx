    ...
    <div className=" p-3 md:p-2 w-full ">
      <div className=' h-18 flex flex-row justify-between items-center rounded-lg bg-[linear-gradient(to_right,#A237A2,#865BC0,#5F89E6)] w-full '>
        <div className='flex flex-col p-4 gap-1'>
            <p className='text-xs md:text-sm font-semibold text-white'>Preview of Gadwalify</p>
            <p className='text-xs md:text-sm font-semibold text-white'>Sign up to get unlimited songs and podcasts with occasional ads. No credit card needed.</p>
